export default function ProductsGridLoader() {
  return (
    <div className="rounded-lg bg-white shadow-lg hover:scale-[1.02] hover:shadow-2xl transition-all duration-300 p-8">
      <div className="h-[200px] w-full aspect-square object-contain flex justify-center items-center">
        <svg
          fill="currentColor"
      ...
      <div className="mt-4">
        <span className="bg-slate-400 w-[80%] h-4 block mb-2"></span>
        <span className="bg-slate-400 w-[60%] h-4 block"></span>
      </div>
    </div>
  );
}
